(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("ezoljs", [], factory);
	else if(typeof exports === 'object')
		exports["ezoljs"] = factory();
	else
		root["ezoljs"] = factory();
})(this, function() {
...
var _Ezol = __webpack_require__(3);

var _Ezol2 = _interopRequireDefault(_Ezol);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var headerView = function headerView() {
  (0, _Ezol2.default)(function (collection, elements, attach) {
    var header = elements.header,
        nav = elements.nav,
        div = elements.div;


    attach(header({ id: 'header' }, '', [nav({ id: 'nav' }, '', [div({ id: 'logo' }, 'I am logo', [])])]), 'body');
  });
};
...
var actions = {
  ...
  addAttrs: function addAttrs(element, attrs) {
    return Object.keys(attrs).map(function (attr) {
      var attrsToAdd = element[attr] = attrs[attr];
...
var createElement = function createElement(type, attrs, text, children) {
...
exports.default = function () {
  ...
  _elements2.default.map(function (type) {
    // elementType :: attrs -> text -> children -> newElement
    elements[type.element] = function (attrs, text, children) {
      validate.attrs(attrs);

      var newEl = createElement(type.element, attrs, text, children);
  ...
  return {
    ...
    elements: elements,
    attach: function attach(element, host) {
...
//# sourceMappingURL=ezoljs.js.map