...
var Ezol = function () {
  function Ezol() {
    _classCallCheck(this, Ezol);

    this.collection = [];
    this.elements = (0, _actions.generateElements)(_elements2.default);
  }

  _createClass(Ezol, [{
    key: "attach",
    value: function attach(element, host) {
...
exports.generateElements = undefined;
...
var addAttrs = function addAttrs(element, attrs) {
...
var generateElements = function generateElements(elementTypes) {
  ...
  elementTypes.map(function (type) {
    ...
    var _ref = function _ref(attrs, text, children) {
      (0, _validate.verifyAttrTypes)(attrs);
...
exports.verifyAttrTypes = verifyAttrTypes;
// attrs :: attributes -> maybe error
function verifyAttrTypes(attrs) {
